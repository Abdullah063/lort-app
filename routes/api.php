...
Route::get('/test-payment-page', function () {
    ...
    $service = new \App\Services\KuveytTurkService();
    $html = $service->initPayment([
        'order_id'    => $orderId,
        'amount'      => $amount,
...
// Callback'ler auth gerektirmez (Kuveyt Türk çağırır)
Route::post('/payment/callback/ok', [PaymentController::class, 'callbackOk']);
Route::post('/payment/callback/fail', [PaymentController::class, 'callbackFail']);
// =============================================
// HERKESE AÇIK
// =============================================
...
Route::middleware('auth:api')
    ->group(function () {
        ...
        Route::prefix('payment')->group(function () {
            Route::post('/start', [PaymentController::class, 'start']);
